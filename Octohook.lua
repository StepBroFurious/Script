...
local library = {
    ...
    Font = getgenv().chosenFont or Drawing.Fonts.Plex; --// Monospace, UI, System, Plex
    images = {
    ...
    signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/StepBroFurious/Script/refs/heads/main/Signal.lua'))();
    open = false;
    opening = false;
    hasInit = false;
